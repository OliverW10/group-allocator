...
namespace GroupAllocator.Database.Migrations
{
    ...
    [Migration("20251109034907_AddFriend")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupAllocator.Database.Model.StudentFriendModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("StudentFriendModelId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StudentFriendModelId");

                    b.HasIndex("StudentId");

                    b.ToTable("StudentFriends");
                });
            ...
            modelBuilder.Entity("GroupAllocator.Database.Model.StudentFriendModel", b =>
                {
                    b.HasOne("GroupAllocator.Database.Model.StudentModel", "Friend")
                        .WithMany()
                        .HasForeignKey("FriendId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GroupAllocator.Database.Model.StudentFriendModel", null)
                        .WithMany("Friends")
                        .HasForeignKey("StudentFriendModelId");
